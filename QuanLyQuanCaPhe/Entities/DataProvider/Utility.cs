...
namespace QuanLyQuanCaPhe.Entities.DataProvider
{
    public class Utility
    {
        ...
        public static string Convert_To_String(int p_objData, int p_Formatter)
        {
            switch (p_Formatter)
            {
                case (int)String_Formatter.Currency_US: p_objData.ToString("N0"); break;
                case (int)String_Formatter.Currency_Vn: p_objData.ToString("N0", new CultureInfo("vi_VN")); break;
            }
